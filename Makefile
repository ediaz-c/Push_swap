...
UTILS		=	ft_check_args.c ft_free.c ft_add_index.c ft_is_sort.c ft_putstr.c swap.c rotate.c reverse.c push.c ft_case_three.c ft_case_five.c ft_case_four.c
